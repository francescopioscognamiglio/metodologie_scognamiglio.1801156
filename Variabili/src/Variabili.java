 ...
 * dichiari una variabile intera i,
 * una variabile di tipo stringa s e una variabile double d.
 * 
 * Quindi vengono svolte le seguenti tre operazioni:
 * - La stringa viene inizializzata al valore
 * 		del primo argomento fornito in input al main
 * - All’intero viene assegnato il valore intero della stringa
 * - Al double viene assegnata la metà del valore di i
 * 		(ad es. se i è pari a 3, d sarà pari a 1.5)
