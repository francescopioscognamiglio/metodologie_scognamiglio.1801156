...
/**
 * Servlet che permette di generare e salvare i dati per il task Sense Annotation
 * @author francescopioscognamiglio
 */
@WebServlet(name = "TaskSenseAnnotationServlet", urlPatterns = "/senseAnnotation.jsp")
public class TaskSenseAnnotationServlet extends BaseTaskServlet {
	...
	protected void doSomething(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (request.getParameter("submit_button") != null) {
			...
			Task task = new Task(StandardTask.SENSE_ANNOTATION.getTaskID(), data, answers);
