 ...
 * e ne memorizzano il nome, il cognome, il codice fiscale e la data di nascita
...
public class PersonaCustom
{
	 ...
	 */
	private static PersonaCustom ultimaPersonaCreata;
	 ...
	 */
	public PersonaCustom(String nome, String cognome, String codiceFiscale, Date dataDiNascita)
	{
		this.nome = nome;
	 ...
	 * @param codiceFiscale il codice fiscale della persona
	 */
	public PersonaCustom(String nome, String cognome, String codiceFiscale)
	{
	 ...
	 * @param cognome il cognome della persona
	 */
	public PersonaCustom(String nome, String cognome)
	{
	...
	{
		PersonaCustom persona = new PersonaCustom("Francesco Pio", "Scognamiglio");
